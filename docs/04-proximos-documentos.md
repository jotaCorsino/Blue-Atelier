...
Objetivo: registrar a consolidacao do primeiro recorte funcional de Colecoes, conectando a tela `/colecoes` ao banco local por repositorio e servico de aplicacao, sem alterar CSS visual e sem implementar CRUD visual.
