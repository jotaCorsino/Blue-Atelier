...
Objetivo: registrar os recortes iniciais do Bloco 9 de Configuracoes, conectando `/configuracoes`, `/configuracoes/caminhos` e `/configuracoes/aparencia` a dados reais do banco local, sem alterar CSS visual, sem salvar alteracoes pela UI, sem validar caminhos reais, sem aplicar tema real e sem acessar o sistema operacional.
...
O proximo recorte deve manter Configuracoes em evolucao progressiva, sem alterar o visual aprovado, sem salvar alteracoes pela UI, sem aplicar tema real, sem validar caminhos reais e sem acessar o sistema operacional sem aprovacao explicita.
