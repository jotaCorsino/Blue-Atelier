...
Objetivo: registrar o primeiro recorte do Bloco 9 de Configuracoes, conectando `/configuracoes` a dados gerais reais do banco local, sem alterar CSS visual, sem salvar alteracoes pela UI, sem validar caminhos reais e sem acessar o sistema operacional.
