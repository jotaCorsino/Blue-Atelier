...
Objetivo: registrar o primeiro recorte do Bloco 5 de Arquivos Vinculados, conectando a secao `Linked Files` do Detalhe do Modelo a metadados reais do banco local sem alterar CSS visual, sem CRUD visual e sem manipular arquivos reais.
